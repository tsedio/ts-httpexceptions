<header class="symbol-info-header">    <h1 id="variantalsonegotiates">VariantAlsoNegotiates</h1>    <label class="symbol-info-type-label class">Class</label>      </header>
<section class="symbol-info">      <table class="is-full-width">        <tbody>        <tr>          <th>Module</th>          <td>            <div class="lang-typescript">                <span class="token keyword">import</span> { VariantAlsoNegotiates }                 <span class="token keyword">from</span>                 <span class="token string">"ts-httpexceptions/serverErrors"</span>                            </div>          </td>        </tr>        <tr>          <th>Source</th>          <td>            <a href="https://TypedProject.github.io/ts-httpexceptions/blob/v4.1.0/src/serverErrors/VariantAlsoNegotiates.ts#L0-L0">                serverErrors/VariantAlsoNegotiates.ts            </a>        </td>        </tr>                </tbody>      </table>    </section>

### Overview

<pre><code class="typescript-lang"><span class="token keyword">class</span> VariantAlsoNegotiates <span class="token keyword">extends</span> <a href="#api/common/core/exception"><span class="token">Exception</span></a> <span class="token punctuation">{</span>
